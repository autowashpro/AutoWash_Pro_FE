...
export const REWARDS: Reward[] = [
  { id: "r-1", title: "Giảm 50.000đ", description: "Áp dụng cho tất cả dịch vụ rửa xe", discountType: "fixed", discountValue: 50000, pointsCost: 500, minTier: "MEMBER", quantity: 150, expiryDate: "2026-12-31", active: true, category: "Rửa xe" },
  { id: "r-2", title: "Giảm 100.000đ", description: "Áp dụng cho dịch vụ nâng cấp", discountType: "fixed", discountValue: 100000, pointsCost: 900, minTier: "SILVER", quantity: 80, expiryDate: "2026-12-31", active: true, category: "Chăm sóc" },
  { id: "r-3", title: "Giảm 10%", description: "Chiết khấu 10% trên tổng hóa đơn", discountType: "percent", discountValue: 10, pointsCost: 1500, minTier: "GOLD", quantity: 45, expiryDate: "2026-11-30", active: true, category: "Bảo vệ" },
  { id: "r-4", title: "Giảm 200.000đ", description: "Áp dụng cho dịch vụ cao cấp", discountType: "fixed", discountValue: 200000, pointsCost: 1800, minTier: "PLATINUM", quantity: 20, expiryDate: "2026-12-31", active: false, category: "Bảo vệ" },
]
